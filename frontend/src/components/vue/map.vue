...
onMounted(() => {
  ...
  remaKjøkkelvik.bindPopup("<b>Rema1000 Kjøkkelvik</b><br>Her kan du levere klær, og kaste glass, metall og matavfall!");

  var stasjonStognafjell = L.marker([60.405207615694536, 5.210220229866483]).addTo(map);
  stasjonStognafjell.bindPopup("<b>Stognafjellsvegen</b><br>Her kan du levere klær, og kaste glass, metall og matavfall");

  var birMøllendal = L.marker([60.38080146477514, 5.354526442798485]).addTo(map);
  birMøllendal.bindPopup("<b>BIR Møllendalsveien</b><br>For full overisikt over hva som kan leveres her, se: <a href='https://bir.no/bli-kvitt-boss/sortering-i-miljoeparken/' id='popuplink'>bir.no</a>");
